...
// Generated: 2026-07-27T04:36:00.294Z
...
export const ENHANCEMENTS_11E: Enhancement[] = [
  ...
  },
  {
    ...
    "description": "^^**Legiones Daemonica Tzeentch Monster**^^ model only. In your Shooting phase, when this unit is selected to shoot, while an enemy unit is visible to a friendly LEGIONES DAEMONICA TZEENTCH unit, that enemy unit has +9\" detection range until this unit has shot.",
    "points": 20,
    "gameSystem": "wh40k-11e"
  },
  {
  ...
  },
  {
    ...
    "faction": "Chaos Space Marines",
    "detachment": "Veterans",
    "description": "HERETIC ASTARTES model only (excluding DAMNED models). [MANUAL PATCH 2026-07-22, reconfirmed still needed 2026-07-27: bearer-restriction clause missing from BSData/wh40k-11e -- see docs/design/11e-support.md.] The bearer’s unit is eligible to shoot and declare a charge in a turn in which it Fell Back. Each time a model in the bearer’s unit makes an attack that targets your focus of hatred, if the bearer’s unit Fell Back this turn, add 1 to the Hit roll, and each time you select your focus of hatred as a target of that unit’s charge, add 1 to the Charge roll.",
    "points": 20,
    "gameSystem": "wh40k-11e"
  },
  {
  ...
  },
  {
    ...
    "faction": "Chaos Space Marines",
    "detachment": "Chaos Cult",
    "description": "DARK APOSTLE or DAMNED model only. [MANUAL PATCH 2026-07-22, reconfirmed still needed 2026-07-27: bearer-restriction clause missing from BSData/wh40k-11e -- see docs/design/11e-support.md.] While the bearer is leading a unit with the Scouts 6” ability, every model in the bearer’s unit has the Scouts 6” ability.",
    "points": 10,
    "gameSystem": "wh40k-11e"
  },
  {
  ...
  },
  {
    ...
    "faction": "Chaos Space Marines",
    "detachment": "Nightmare Hunt",
    "description": "CHAOS LORD WITH JUMP PACK model only. [MANUAL PATCH 2026-07-22, reconfirmed still needed 2026-07-27: bearer-restriction clause missing from BSData/wh40k-11e -- see docs/design/11e-support.md. BSData's 2026-07-27 sync also newly dropped the second sentence below (\"...can be attached to a Warp Talons unit\"), restored from the same source.] Models in the bearer’s unit have the Scouts 6\" ability.\nIn the Declare Battle Formations step, the bearer can be attached to a Warp Talons unit.",
    "points": 35,
    "gameSystem": "wh40k-11e"
  },
  {
  ...
  },
  {
    ...
    "description": "The bearer has the Deep Strike ability, and it has the BLOOD LEGIONS Faction keyword instead of the WORLD EATERS Faction keyword.",
    "points": 15,
    "gameSystem": "wh40k-11e"
  },
  {
  ...
  },
  {
    ...
    "description": "CANONESS, PALATINE, or MINISTORUM PRIEST model only. The bearer gains the PENITENT keyword.",
    "points": 15,
    "gameSystem": "wh40k-11e"
  },
  {
  ...
  },
  {
    ...
    "faction": "Astra Militarum",
    "detachment": "Combined Arms",
    "description": "**^^Officer^^** model only. Each time an enemy unit is set up within 8\" of the bearer's unit, the bearer can issue one Order. This is not counted towards the number of Orders the bearer can issue each battle round.",
    "points": 15,
    "gameSystem": "wh40k-11e"
  },
  {
  ...
  },
  {
    ...
    "faction": "Astra Militarum",
    "detachment": "Recon Elements",
    "description": "**^^Astra Militarum Infantry^^** model only. Each time an enemy **^^Infantry^^** or **^^Mounted^^** unit ends a Normal, Advance, Charge, or Fall Back move within 8\" of the bearer's unit, roll a D6; on a 4+, until the start of your next turn, that enemy unit is stunned. While a unit is stunned, each time a model in that unit makes an attack, subtract 1 from the Hit roll.",
    "points": 20,
    "gameSystem": "wh40k-11e"
  },
  {
  ...
  },
  {
    ...
    "description": "**GREY KNIGHTS** model only. When this unit ends an **ingress move**, you can use this ability. If you do:\n- This unit can make a **normal move** of up to D6\".\n- Until the end of the turn, this unit is <ins>not</ins> **eligible to declare a charge**.",
    "points": 15,
    "gameSystem": "wh40k-11e"
  },
  {
  ...
  },
  {
    ...
    "description": "SPACE WOLVES model only. Add 2\" to the Move characteristic of the bearer",
    "points": 15,
    "gameSystem": "wh40k-11e"
  },
  {
  ...
  {
    "id": "8a01-65e4-0ce6-91cf",
    "name": "Avenging Angel",
    "faction": "Adeptus Astartes - Space Marines",
    "detachment": "Vengeful Hosts",
    "description": "ADEPTUS ASTARTES FLY INFANTRY model only. When this unit ends an ingress move, select up to one enemy unit within 9\" of this unit. That enemy unit makes a battle-shock roll, with -1 to that\nbattle-shock roll.",
    "points": 20,
    "gameSystem": "wh40k-11e"
  },
  {
    "id": "aa90-2488-e3dc-26c9",
    "name": "Orksbane",
    "faction": "Adeptus Astartes - Space Marines",
    "detachment": "Vengeful Hosts",
    "description": "ADEPTUS ASTARTES FLY INFANTRY model only. This model has the following weapon:",
    "points": 20,
    "gameSystem": "wh40k-11e"
  },
  {
  ...
  },
  {
    ...
    "faction": "Necrons",
    "detachment": "Cursed Legion",
    "description": " The bearer has the DESTROYER CULT keyword. Add 3\" to the Move characteristic of the bearer.",
    "points": 15,
    "gameSystem": "wh40k-11e"
  },
  {
  ...
  },
  {
    ...
    "faction": "T'au Empire",
    "detachment": "Mont'ka",
    "description": "In the Resolve Pre-battle Abilities step, you can select up to two friendly **T’AU EMPIRE** units within 6\" of this model that do not have the **Scouts** ability. Until the end of the battle, all models in the selected units have the **Scouts 6\"** ability.",
    "points": 35,
    "gameSystem": "wh40k-11e"
  },
  {
  ...
  },
  {
    ...
    "faction": "Tyranids",
    "detachment": "Vanguard Onslaught",
    "description": "**VANGUARD INVADER** model only. This unit has **Stealth**.",
    "points": 15,
    "gameSystem": "wh40k-11e"
  },
  {
