...
// Generated: 2026-09-05T09:39:15.534Z
...
export const DETACHMENTS_11E: Detachment[] = [
  ...
  },
  {
    ...
    "ability": {
      ...
      "description": "Friendly **ASTRA MILITARUM** units (excluding **TITANIC** units) have **Stealth**."
    },
    "detachmentPoints": 2,
    "dispositions": [
      "Reconnaissance"
  ...
  },
  {
    ...
    "ability": {
      "name": "Old Greymanes",
      "description": " When a friendly GREY HUNTER unit starts an action, that action does not prevent this unit from being eligible to shoot.\n\n\n▪ In the Declare Battle Formations step,  each containing as equal a number of models as possible (when splitting a unit in this way, make a note of which models form each of the two new units)\n\n\nRestrictions: Your army can include SPACE WOLVES units, but it\ncannot include any ADEPTUS ASTARTES units drawn from any\nother Chapter."
    },
    "detachmentPoints": 1,
    "dispositions": [
      "Disruption"
  ...
  {
    "id": "39c2-616a-92c8-ad9d",
    "name": "Armoured Trailblazers",
    "faction": "Leagues of Votann",
    "ability": {
      "name": "Sagitaur Spearhead",
      "description": "Friendly **^^Sagitaur^^** units have **Scouts 6\"**."
    },
    "detachmentPoints": 1,
    "dispositions": [
      "Disruption"
